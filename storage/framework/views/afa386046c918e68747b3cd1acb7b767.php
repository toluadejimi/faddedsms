...
<head><title>FADDEDSMS | LOGIN</title><!-- [Meta] -->
    <meta charset="utf-8">
    <meta charset="utf-8">
    ...
    <div class="auth-wrapper v1">
        <div class="auth-form">
            ...
            <div class="card my-5" style="box-shadow: 4px 2px 28px rgba(94,94,94,0.37);">
                ...
                <p class="mb-4 text-muted text-center">  Welcome back!
                    ...
                    <form action="login_now" method="post">
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" style="background: rgb(6 65 116); border: 0px" class="btn btn-lg btn-primary">Login</button>
                        </div>
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><h6 class="mb-1">Theme layout</h6>
                    ...
                    <div class="theme-main-layout d-flex align-center gap-1 w-100"><a href="login-v1.html#!"
                                ...
                                src="<?php echo e(url('')); ?>/public/assets/images/customizer/caption-on.svg" alt="img"
                                class="img-fluid"> </a><a
                            href="login-v1.html#!" data-bs-toggle="tooltip" title="Horizontal"
                            data-value="horizontal"><img
                                src="<?php echo e(url('')); ?>/public/assets/images/customizer/horizontal.svg" alt="img"
                                class="img-fluid"> </a><a href="login-v1.html#!"
                                                          data-bs-toggle="tooltip"
                                                          title="Color Header"
                                                          data-value="color-header"><img
                                src="<?php echo e(url('')); ?>/public/assets/images/customizer/color-header.svg" alt="img"
                                class="img-fluid"> </a><a
                            href="login-v1.html#!" data-bs-toggle="tooltip" title="Compact" data-value="compact"><img
                                src="<?php echo e(url('')); ?>/public/assets/images/customizer/compact.svg" alt="img"
                                class="img-fluid"> </a><a
                            href="login-v1.html#!" data-bs-toggle="tooltip" title="Tab" data-value="tab"><img
                                src="<?php echo e(url('')); ?>/public/assets/images/customizer/tab.svg" alt="img"
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn-img btn active" data-value="true"
                                        ...
                                        src="<?php echo e(url('')); ?>/public/assets/images/customizer/caption-on.svg"
                        ...
                        <div class="col-6">
                            <div class="d-grid">
                                <button class="preset-btn btn-img btn" data-value="false"
                                        ...
                                        src="<?php echo e(url('')); ?>/public/assets/images/customizer/caption-off.svg"
                                        alt="img" class="img-fluid"></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        <img src="<?php echo e(url('')); ?>/public/assets/images/customizer/ltr.svg" alt="img"
                                             class="img-fluid">
                                    </button>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        <img src="<?php echo e(url('')); ?>/public/assets/images/customizer/rtl.svg" alt="img"
                                             class="img-fluid">
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                            ...
                                            src="<?php echo e(url('')); ?>/public/assets/images/customizer/full.svg" alt="img"
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                            ...
                                            src="<?php echo e(url('')); ?>/public/assets/images/customizer/fixed.svg"
                                            alt="img" class="img-fluid"></button>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/faddedsms/resources/views/Auth/login.blade.php ENDPATH**/ ?>