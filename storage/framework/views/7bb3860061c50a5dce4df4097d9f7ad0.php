<?php $__env->startSection('content'); ?>
    ...
    <script>
        ...
        function makeRequest() {
            fetch('<?php echo e(url('')); ?>/get-smscode?num=<?php echo e($sms_order->phone); ?>')
                .then(response => {
                    if (!response.ok) {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/project/faddedsms/resources/views/receivesms.blade.php ENDPATH**/ ?>