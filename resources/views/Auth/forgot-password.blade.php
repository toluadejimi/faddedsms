                ...
                <div class="card my-5" style="box-shadow: 4px 2px 28px rgba(94,94,94,0.37);">
                    ...
                    <form method="POST" action="reset-password">
                        ...
                        <div>
                            ...
                            <input
                                class="form-control"
                                id="email" type="email" name="email" placeholder="Enter your email" required="required" autofocus="autofocus">
                        </div>
                        ...
                        <div class="d-grid mt-4">
                            <button type="submit" style="background: rgb(63,63,63); border: 0px" class="btn btn-primary">Reset</button>
                        </div>
